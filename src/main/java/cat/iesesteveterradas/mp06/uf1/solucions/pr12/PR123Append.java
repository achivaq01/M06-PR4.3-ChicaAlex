...
public class PR123Append {
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter(outputFile, true)) { // true per a afegir al final
            writer.write("Yo sólo puedo mostrarte la puerta\n");
            writer.write("Tú eres quien la tiene que atravesar\n");
            System.out.println("S'ha annexat el contingut al fitxer " + outputFile.getAbsolutePath());
        } catch (IOException e) {
